...
public class OwnOptions extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					OwnOptions frame = new OwnOptions(new FacadeImplementationWS());
	 ...
	 * Create the frame.
	 */
	public OwnOptions(ApplicationFacadeInterfaceWS bl) {
		setBusinessLogic(bl);
		...
		btnSetOffer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				SetAvailabilityGUI sa= new SetAvailabilityGUI(businessLogic.getAllRuralHouses());
				sa.setVisible(true);
			}
		});
		...
		btnDeleteOffer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				DeleteOfferGUI dg= new DeleteOfferGUI(bl, businessLogic.getAllOffers());
				dg.setVisible(true);
			}
		});
		...
		btnRemoveHouse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				DeleteRuralHouseGUI dr= new DeleteRuralHouseGUI(bl, businessLogic.getAllRuralHouses());
				dr.setVisible(true);
